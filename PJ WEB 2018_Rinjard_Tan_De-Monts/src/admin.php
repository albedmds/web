...
<body>
  ...
  if ($db_found) {
   ...
   echo("<div align=\"center\" class=\"jumbotron\" style=\"background-color:#e3f2fd;\">"."<h2>Table des utilisateurs</h2>"." <br \>"."<h3>Code_Personne | Nom | Prenom | Pseudo | Email | Mot_de_passe</h3>"."<br \><br \>"." <a href=\"ajouter.html\" class=\"btn btn-default\">ajouter</a></div>"   );
   while($resultat=mysqli_fetch_object($result)){
    echo(
     ...
     ." <a href=\"modif.php?idPersonne=".$resultat->Code_Personne."\" class=\"btn btn-default\">modifier</a>"."    "
